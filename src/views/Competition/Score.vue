<template>
  <div class="app-container">
    ...
    <el-tabs v-model="activeName" @tab-click="tabHandleClick">
      <el-tab-pane label="评分表" name="first" />
      <el-tab-pane label="网赛评分" name="second" />
      <el-tab-pane label="网赛成绩" name="third" />
      <el-tab-pane label="出线名单" name="fourth" />
    </el-tabs>
    <!-- 表格内容 -->
    <el-table
      :key="tableKey"
    ...
    >
      ...
      <el-table-column label="评分表信息" min-width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.name }}</span>
        </template>
      </el-table-column>
